...
public class OrderItem implements Serializable {
	...
	@ManyToOne
	@JoinColumns({
		@JoinColumn(name="ORDER_ITEM_GROUP_ORDER_ID", referencedColumnName="ORDER_ID"),
		@JoinColumn(name="ORDER_ITEM_GROUP_SEQ_ID1", referencedColumnName="ORDER_ITEM_GROUP_SEQ_ID")
		})
