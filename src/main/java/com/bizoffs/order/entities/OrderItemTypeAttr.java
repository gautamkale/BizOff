...
/**
 * The persistent class for the ORDER_ITEM_TYPE_ATTR database table.
 * 
 */
@Entity
@Table(name="ORDER_ITEM_TYPE_ATTR")
@NamedQuery(name="OrderItemTypeAttr.findAll", query="SELECT o FROM OrderItemTypeAttr o")
public class OrderItemTypeAttr implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private OrderItemTypeAttrPK id;
