...
public final class UtilDateTime {
    ...
    private static Logger log     = LoggerFactory.getLogger(UtilDateTime.class);
    ...
    public static String formatInterval(double interval, int count, Locale locale) {
        ...
        Map<String, Object> uiDateTimeMap = new HashMap<>();//UtilProperties.getResourceBundleMap("DateTimeLabels", locale);
    ...
    private static class TimeZoneHolder {
        ...
        private static List<TimeZone> getTimeZones() {
            ...
            if (!tzString.isEmpty()) {
                idList = Arrays.stream(tzString.split(",")).collect(Collectors.toList());
            } else {
